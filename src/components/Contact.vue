<template>
  <Popup :show="store.isContactOpen" @close="store.isContactOpen = false">
    ...
    >
      <div class="mb-3">
        <label for="FullName" class="mb-2 block text-sm font-bold text-gray-900"
          >Puno ime:</label
        >
        <input
          type="text"
      ...
      <div class="mb-3">
        <label for="Message" class="mb-2 block text-sm font-bold text-gray-900"
          >Vaša poruka:</label
        >
        <textarea
          class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 outline-none focus:border-blue-500"
      ...
      <div class="mb-5 flex items-center">
        <label class="text-sm font-bold text-gray-900" for="ReceiveNewsletter">
